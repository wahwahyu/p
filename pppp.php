 ...
 * @Last Modified by:   wahyu
 * @Last Modified time: 2018-08-17 15:13:34
*/
##############################################################################################################
$config['deviceCode'] 		= '869711039492493';
$config['tk'] 				= 'ACG_ErObhw9MR7CkZyBFWEFwB9FFW3LnzkdxdHRodw';
$config['token'] 			= '33c7qQJRyHeJR_QAQkZ9uTX8618EBOyN4slLpQU3ttajMsdmZ3nfw1UaQSqJbuKCCqCHLXY';
$config['uuid'] 			= '73bfae5dc45e459aaa6874558b4e300e';
$config['sign'] 			= '1f11e11d3698356cb20ef7d69d554ae7';
$config['android_id'] 		= '82ab25bd6a3a6943';
##############################################################################################################
for ($x=0; $x <1; $x++) { 
	$url 	= array(); 
